...
dfx canister call ryjl3-tyaaa-aaaaa-aaaba-cai icrc1_transfer "(record { to = record { owner = principal \"$BOT1_PRINCIPAL\"; subaccount = null }; amount = 999999999900000000 })"

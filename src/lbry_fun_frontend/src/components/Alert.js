...
export function Alert({ variant = "default", title, children, className, icon: CustomIcon, }) {
    const { container, heading, text, icon: DefaultIcon } = variants[variant];
    const Icon = CustomIcon || DefaultIcon;
    return (React.createElement("div", { className: cn("rounded-md p-3 border mb-3", container, className) },
        React.createElement("div", { className: cn("flex items-center gap-2", heading) },
            React.createElement(Icon, { className: "h-4 w-4" }),
            title && React.createElement("h4", { className: "font-medium text-sm" }, title)),
        React.createElement("div", { className: cn("mt-1 text-sm", text) }, children)));
}

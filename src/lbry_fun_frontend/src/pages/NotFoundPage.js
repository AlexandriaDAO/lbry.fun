    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("div", { className: "min-h-[80vh] flex items-center justify-center px-4" },
            React.createElement("div", { className: "text-center" },
                React.createElement("h1", { className: "text-9xl font-bold text-gray-200" }, "404"),
                React.createElement("div", { className: "mt-4" },
                    React.createElement("h3", { className: "text-2xl font-semibold text-gray-800 md:text-3xl" }, "Page Not Found"),
                    React.createElement("p", { className: "mt-4 text-gray-600" }, "The page you're looking for doesn't exist or has been moved."),

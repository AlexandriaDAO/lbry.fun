...
export default function App() {
    ...
    return (React.createElement(ThemeProvider, { defaultTheme: "dark", storageKey: "vite-ui-theme" },
        React.createElement(ReduxProvider, null,
            React.createElement(InternetIdentityProvider, null, isReady ? React.createElement(AppRoutes, null) : null))));
}

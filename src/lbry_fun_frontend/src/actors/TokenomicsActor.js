...
export default function TokenomicsActor({ children }) {
    ...
    return (React.createElement(ActorProvider, { canisterId: canisterId, context: TokenomicsContext, identity: identity || new AnonymousIdentity(), idlFactory: idlFactory, onRequest: handleRequest, onRequestError: (error) => errorToast(error), onResponse: handleResponse, onResponseError: handleResponseError }, children));
}

...
export function PrincipalToggle({ value, label, isSelected, onToggle, variant = 'default' }) {
    ...
    return (React.createElement("button", { onClick: () => onToggle(value), className: `${baseStyles} ${variantStyles[variant]}` },

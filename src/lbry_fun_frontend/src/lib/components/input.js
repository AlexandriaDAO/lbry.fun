...
const Input = React.forwardRef(({ className, type, variant, scale, rounded, ...props }, ref) => {
    return (React.createElement("input", { type: type, className: cn(inputVariants({ variant, scale, rounded, className })), ref: ref, ...props }));
});

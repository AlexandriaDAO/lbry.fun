...
const DialogContent = React.forwardRef(({ className, children, closeIcon = React.createElement(X, { className: "h-4 w-4" }), ...props }, ref) => (React.createElement(DialogPortal, null,

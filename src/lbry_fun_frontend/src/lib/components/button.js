...
const Button = React.forwardRef(({ className, variant, scale, rounded, asChild = false, ...props }, ref) => {
    const Comp = asChild ? Slot : "button";
    return (React.createElement(Comp, { className: cn(buttonVariants({ variant, scale, rounded, className })), ref: ref, ...props }));
});

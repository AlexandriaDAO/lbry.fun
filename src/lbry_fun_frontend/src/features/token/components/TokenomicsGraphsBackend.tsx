...
const TokenomicsGraphsBackend: React.FC<TokenomicsGraphsBackendProps> = ({
  ...
  return (
    <>
      {warnings.length > 0 && (
        <div className="my-4 p-4 border border-yellow-400 bg-yellow-50 rounded-lg dark:bg-yellow-900/20 dark:border-yellow-600">
          <h3 className="font-bold text-yellow-800 dark:text-yellow-300">Parameter Warnings</h3>
          <ul className="list-disc list-inside text-yellow-700 dark:text-yellow-400 mt-2 space-y-1">

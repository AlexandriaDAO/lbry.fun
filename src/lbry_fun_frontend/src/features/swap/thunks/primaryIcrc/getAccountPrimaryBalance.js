...
const getAccountPrimaryBalance = createAsyncThunk("primary/getAccountPrimaryBalance", async (account, { getState, rejectWithValue }) => {
    try {
    ...
    return rejectWithValue("An unknown error occurred while fetching ALEX balance");
});

...
// interface LogData {
//   primary_rate: bigint;
//   primary_supply: bigint;
//   apy: bigint;
//   lbry_supply: bigint;
//   nft_supply: bigint;
//   staker_count: bigint;
//   time: bigint;
//   total_primary_staked: bigint;
...
//       primary: Number(logData.primary_supply) / 100_000_000,
//       nft: Number(logData.nft_supply),
//       totalPrimaryStaked: Number(logData.total_primary_staked) / 100_000_000,
//       stakerCount: Number(logData.staker_count),
//       primaryRate: Number(logData.primary_rate)/10_000,

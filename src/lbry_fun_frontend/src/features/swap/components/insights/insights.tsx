    ...
    return (
        <div className="container mx-auto px-4 py-8">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                        ...
                        <div className="terminal-info">
                            <div className="terminal-row">
                                ...
                                <span className="terminal-primary">{summaryData.apy.toFixed(2)}%</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div>
                    <div className="flex items-center mb-2">
                        <h3 className="text-xl font-medium text-white">APY</h3>
                        <TooltipIcon text="The Annual Percentage Yield for staking." />
                    </div>
                    <LineChart dataXaxis={formattedTime} dataYaxis={insights.apy} xAxisLabel="Time" yAxisLabel="APY (%)" lineColor="hsl(var(--color-chart-success))" gardientColor="hsl(var(--color-chart-success) / 0.3)" />
                </div>

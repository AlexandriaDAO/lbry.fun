    ...
    return (
        <div className="container mx-auto px-4 py-8">
            <div className="text-center mb-8">
                <h2 className="text-3xl font-bold text-white">Swap Pool Insights</h2>
                <p className="text-md text-gray-400">Live data from the on-chain logs canister.</p>
            </div>

            {summaryData && (
                 <div className="mb-8 p-4 border rounded-lg bg-gray-800">
                    <h3 className="text-xl font-semibold mb-4 text-center text-white">Latest Metrics</h3>
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 text-center">
                        <div className="p-2 bg-gray-700 rounded-md">
                            <p className="text-sm text-gray-400">Primary Supply</p>
                            <p className="text-lg font-bold text-white">{summaryData.primaryTokenSupply.toLocaleString()}</p>
                        </div>
                        <div className="p-2 bg-gray-700 rounded-md">
                            <p className="text-sm text-gray-400">Secondary Supply</p>
                            <p className="text-lg font-bold text-white">{summaryData.secondaryTokenSupply.toLocaleString()}</p>
                        </div>
                        <div className="p-2 bg-gray-700 rounded-md">
                            <p className="text-sm text-gray-400">Total Secondary Burned</p>
                            <p className="text-lg font-bold text-white">{summaryData.totalSecondaryBurned.toLocaleString()}</p>
                        </div>
                        <div className="p-2 bg-gray-700 rounded-md">
                            <p className="text-sm text-gray-400">Total Primary Staked</p>
                            <p className="text-lg font-bold text-white">{summaryData.totalPrimaryStaked.toLocaleString()}</p>
                        </div>
                        <div className="p-2 bg-gray-700 rounded-md">
                            <p className="text-sm text-gray-400">Stakers</p>
                            <p className="text-lg font-bold text-white">{summaryData.stakerCount}</p>
                        </div>
                        <div className="p-2 bg-gray-700 rounded-md">
                            <p className="text-sm text-gray-400">ICP in LP</p>
                            <p className="text-lg font-bold text-white">{summaryData.icpInLpTreasury.toLocaleString()}</p>
                        </div>
                        <div className="p-2 bg-gray-700 rounded-md">
                            <p className="text-sm text-gray-400">APY</p>
                            <p className="text-lg font-bold text-white">{summaryData.apy.toFixed(2)}%</p>
                        </div>
                    </div>
                </div>
            )}

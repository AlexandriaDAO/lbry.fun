                ...
                <div className="relative flex items-center justify-center w-40 h-40 mx-auto rounder-full mb-5">
                    ...
                    <svg viewBox="0 0 160 160" className="animate-spin">
                        <g id="Group_6891" data-name="Group 6891" transform="translate(-3382 704)">
                            <g id="Ellipse_110" data-name="Ellipse 110" transform="translate(3382 -704)" fill="none" stroke="currentColor" stroke-opacity="0.2" strokeWidth="5">
                                <circle cx="80" cy="80" r="80" stroke="none" />
                                <circle cx="80" cy="80" r="77.5" fill="none" />
                            </g>
                            <g id="Ellipse_111" data-name="Ellipse 111" transform="translate(3382 -704)" fill="none" stroke="currentColor" strokeWidth="5" stroke-dasharray="161 362">
                                <circle cx="80" cy="80" r="80" stroke="none" />
                                <circle cx="80" cy="80" r="77.5" fill="none" />
                            </g>
                        </g>

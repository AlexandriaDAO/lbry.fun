        ...
        >
            <div className='bg-primary py-5 px-7 me-3 rounded-3xl mb-5'>
                <div className='flex justify-between items-center mb-3'>
                    <div>
                        <h4 className='text-2xl font-medium text-primary-foreground'>{swap.activeSwapPool&&swap.activeSwapPool[1].primary_token_name}</h4>
                        <span className='text-sm font-regular text-primary-foreground/70'>{swap.activeSwapPool&&swap.activeSwapPool[1].primary_token_symbol}</span>
                    </div>
                    <div>
                ...
                <div className="flex text-center justify-between">
                    ...
                    <h4 className='text-2xl font-medium mb-1 text-primary-foreground'>{primary.primaryBal}</h4>
                    <span className='text-base text-primary-foreground/70 font-medium'> ≈ $ {primaryBalUsd.toFixed(2)}</span>
                </div>
            </div>
        </div>
    </>)

        ...
        <div>
            ...
            <div className='grid grid grid-cols-1 2xl:grid-cols-2 xl:grid-cols-2 lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 mb-12'>
                <div className='me-0 2xl:me-3 xl:me-3 lg:me-3 md:me-3 sm:me-0 mb-3 2xl:mb-0 xl:mb-0 lg:mb-3 md:mb-3 sm:mb-3'>
                    ...
                    <div className="relative inline-block w-full mb-4">
                        <div
                            ...
                            className="flex justify-between items-center border border-gray-600 rounded-full bg-gray-800 py-4 px-5 lg:text-2xl md:text-xl sm:text-lg xs:text-base font-semibold cursor-pointer"
                        >
                            <div className='flex items-center'>
                                {selectedImage ? <img className='h-5 w-5 me-3' src={selectedImage} alt="Selected" /> : null}
                                <span className='lg:text-xl md:text-lg sm:text-sm font-medium text-white'>{selectedOption}</span>
                            </div>
                                ...
                                {dynamicOptions.map((option, index) => {
                                    return (
                                        <div
                                            ...
                                            className="flex items-center py-2 px-4 hover:bg-gray-700 cursor-pointer text-white"
                                        >
                                            {option.img ? (
                    ...
                    <div className="relative inline-block w-full mb-4">
                        ...
                        >
                            ...
                            <div className='flex items-center'>
                                <span className='lg:text-xl md:text-lg sm:text-sm font-medium text-white'>{selectedNetwork}</span>
                    ...
                    <div className="flex items-center">
                        ...
                        <div className="w-[calc(100%-140px)]">
                            ...
                            <div className='border border-gray-600 py-5 px-5 rounded-borderbox flex items-center justify-between bg-gray-800'>
                                <p className='truncate text-lg font-medium text-gray-300 me-5'>{principal ? principal.toString() : ""}</p>
                                <div>
                ...
                <div className='ms-0 2xl:ms-3 xl:ms-3 lg:ms-3 md:ms-3 sm:ms-0'>
                    <div className='border border-gray-600 text-white py-5 px-5 rounded-2xl bg-gray-800'>
                        <ul className='ps-0'>
                            <li className='flex justify-between mb-5'>
                                <strong className='text-lg font-medium me-1 text-gray-300'>Minimum deposit amount</strong>
                                <span className='text-lg font-medium text-gray-300'>0.001 {selectedOption}</span>
                            </li>
                            <li className='flex justify-between mb-5'>
                                <strong className='text-lg font-medium me-1 text-gray-300'>Network Fees:</strong>
                                <span className='text-lg font-medium text-gray-300'><span className='text-interactive-accent'>{fee}</span> {selectedOption}</span>
                            </li>
                            <li>
                                <p className='text-lg font-medium text-gray-300'>Do not deposit assets other than those listed as this may result in irretrievability of deposited assets.</p>
                            </li>
                        </ul>
                    </div>
                </div>

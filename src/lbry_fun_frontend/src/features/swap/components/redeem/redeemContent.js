...
const RedeemContent = () => {
    ...
    return (React.createElement("div", null,
        React.createElement("div", { className: "mb-5 2xl:mb-10 xl:mb-7 lg:mb-7 md:mb-6 sm:mb-5" },
            React.createElement("h3", { className: "text-tabsheading 2xl:text-xxltabsheading xl:text-xltabsheading lg:text-lgtabsheading md:text-mdtabsheading sm:text-smtabsheading font-bold dark:text-white" }, "Redeem")),
        React.createElement("div", { className: "grid grid-cols-1 2xl:grid-cols-2 xl:grid-cols-2 lg:grid-cols-2 md:grid-cols-1 sm:grid-cols-1" },
            React.createElement("div", { className: "me-0 2xl:me-2 xl:me-2 lg:me-2 md:me-0 sm:me-0 mb-3 2xl:mb-0 xl:mb-0 lg:mb-0 md:mb-3 sm:mb-3" },
                React.createElement("div", { className: "block 2xl:flex xl:flex lg:flex md:flex sm:block justify-between mb-5 w-full" },
                    React.createElement("div", { className: `bg-white dark:bg-gray-800 border border-gray-400 dark:border-gray-700 text-black dark:text-white py-5 px-7 rounded-borderbox me-0 2xl:me-2 xl:me-2 lg:me-2 md:me-2 sm:me-0 w-full 2xl:w-6/12 xl:w-6/12 lg:w-6/12 md:w-6/12 sm:w-full mb-3 2xl:mb-0 xl:mb-0 lg:mb-0 md:mb-0 sm:mb-3` },
                        React.createElement("div", { className: "flex justify-between" },
                            React.createElement("h2", { className: "text-swapheading lg:text-lgswapheading md:text-mdswapheading ms:text-smswapheading font-medium text-black dark:text-white" },
                                "Archived ICP ",
                                swap.archivedBalance),
                            React.createElement("div", null)))),
                React.createElement("div", null, isAuthenticated ? React.createElement("button", { type: "button", className: "bg-balancebox text-white w-full rounded-full text-base 2xl:text-2xl xl:text-xl lg:text-xl md:text-lg sm:text-base font-semibold py-2 2xl:py-4 xl:py-4 lg:py-3 md:py-3 sm:py-2 px-2 2xl:px-4 xl:px-4 lg:px-3 md:px-3 sm:px-2 mb-6", onClick: () => {
                        if (principal) {
                            handleSubmit();
                        }
                        else {
                    ...
                    React.createElement(LoaderPinwheel, { className: "animate-spin text-white mx-auto" }))) : (React.createElement(React.Fragment, null, "Redeem"))) : React.createElement("div", { className: "bg-balancebox text-white w-full rounded-full text-base 2xl:text-2xl xl:text-xl lg:text-xl md:text-lg sm:text-base font-semibold py-2 2xl:py-4 xl:py-4 lg:py-3 md:py-3 sm:py-2 px-2 2xl:px-4 xl:px-4 lg:px-3 md:px-3 sm:px-2 flex items-center justify-center white-auth-btn mb-4" },
                    React.createElement(Entry, null))))),
        React.createElement(LoadingModal, { show: loadingModalV, message1: "Redeem transaction in Progress", message2: "Redeem transaction is being processed. This may take a few moments.", setShow: setLoadingModalV }),

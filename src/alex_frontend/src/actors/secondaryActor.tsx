...
import { canisterId, idlFactory } from "../../../declarations/SECONDARY";

import { _SERVICE } from "../../../declarations/SECONDARY.did";
...
export default function SecondaryActor({ children }: { children: ReactNode }) {
